        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-6 mb-8">
            <a
              ...
              className="group p-4 rounded-full transition-all duration-300 hover:scale-110 bg-gray-800/50 backdrop-blur-sm text-gray-300 hover:bg-gray-700/50 hover:text-white focus:outline-none"
            >
