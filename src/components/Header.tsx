...
const Header: React.FC<HeaderProps> = ({ mobileMenuOpen, setMobileMenuOpen }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-lg border-b bg-black/10 border-white/10 transition-all duration-300 pt-safe">
      <div className="container mx-auto px-4 py-1 lg:py-4">
        <div className="flex items-center justify-between relative">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 flex-1 lg:flex-none justify-end">
            ...
            <button
              ...
              className="lg:hidden p-1.5 lg:p-3 min-w-[36px] min-h-[36px] lg:min-w-[44px] lg:min-h-[44px] rounded-full transition-all text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none active:bg-gray-600 touch-manipulation flex items-center justify-center"
            >
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="lg:hidden mt-2 py-2 lg:mt-4 lg:py-4 border-t border-gray-700 transition-all duration-300">
            ...
            <div className="flex items-center space-x-3 mt-2 pt-2 lg:mt-4 lg:pt-4 border-t border-gray-700">
              <a
                href="https://github.com/zak-510"
                target="_blank"
                rel="noopener noreferrer"
